...
app.use(cors({
    origin: 'https://wgep.netlify.app', //origen https://sparkling-torte-716cbe.netlify.app  http://localhost:5173
...
app.get('/recoverUserMarks', (req, res) =>{
    ...
    const sql = `SELECT 
                    ...
                    temes.nom_tema, 
                    tests.nom_test, 
                    resultats.realitzacio, 
                    resultats.nota
                FROM 
                    resultats
                JOIN 
                    tests ON resultats.id_test = tests.id_test
                JOIN 
                    temes ON tests.id_tema = temes.id_tema
                WHERE 
                    resultats.id_alumne = ?`
